<!-- Teach them how to add 2 y axes. Sequences <29000 skewed the tree.-->
...
Make one file each for Denmark, Norway, and Sweden that we'll use in future chapters. An example is below.

```
grep "^Norway" owid-covid-data.csv > Norwaydata.csv
```

Make one file each for each of your countries.
